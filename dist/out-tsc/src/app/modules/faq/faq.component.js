...
var FaqComponent = /** @class */ (function () {
    function FaqComponent(client, service) {
        this.client = client;
        this.service = service;
        this.category = 'all';
    }
    Object.defineProperty(FaqComponent.prototype, "_category", {
        set: function (value) {
            this.category = value;
            this.loadFaq();
        },
    ...
    FaqComponent.prototype.loadFaq = function () {
    ...
    FaqComponent.prototype.goTo = function (category, i) {
        var fragment = "faq-" + category + "--" + i;
        var element = document.querySelector('#' + fragment);
        if (element) {
            setTimeout(function () {
                var top = element.getBoundingClientRect().top + window.scrollY - 60;
    ...
    ], FaqComponent.prototype, "_category", null);
