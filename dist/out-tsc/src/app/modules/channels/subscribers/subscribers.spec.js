...
describe('ChannelSubscribers', function () {
    ...
    beforeEach(function (done) {
        ...
        fixture = testing_1.TestBed.createComponent(subscribers_1.ChannelSubscribers);
        ...
        client_mock_spec_1.clientMock.response["api/v1/subscribe/subscribers/guid"] = {
            'status': 'success',
            'users': [{}, {}, {}]
        };
    ...
    it('should load all entities', testing_1.fakeAsync(function () {
        ...
        expect(client_mock_spec_1.clientMock.get.calls.mostRecent().args[0]).toEqual('api/v1/subscribe/subscribers/guid');
    }));
...
//# sourceMappingURL=subscribers.spec.js.map