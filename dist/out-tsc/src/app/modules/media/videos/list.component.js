...
var MediaVideosListComponent = /** @class */ (function () {
    function MediaVideosListComponent(client, router, route, title, context, session, overlayModal) {
        this.client = client;
        this.router = router;
        this.route = route;
        this.title = title;
    ...
    MediaVideosListComponent.prototype.ngOnInit = function () {
        var _this = this;
    ...
    MediaVideosListComponent.prototype.showPoster = function () {
    ...
    MediaVideosListComponent.prototype.ngOnDestroy = function () {
        this.paramsSubscription.unsubscribe();
    };
    MediaVideosListComponent.prototype.reloadTags = function (all) {
        if (all === void 0) { all = false; }
        this.all = all;
        this.load(true);
    };
    MediaVideosListComponent.prototype.load = function (refresh) {
        var _this = this;
    ...
    MediaVideosListComponent.prototype.reloadTopFeed = function () {
        this.load(true);
    };
    MediaVideosListComponent.prototype.onOptionsChange = function (e) {
        var _this = this;
    ...
    MediaVideosListComponent.prototype.openHashtagsSelector = function () {
        var _this = this;
    ...
    MediaVideosListComponent = __decorate([
        core_1.Component({
            moduleId: module.id,
    ...
    return MediaVideosListComponent;
}());
exports.MediaVideosListComponent = MediaVideosListComponent;
