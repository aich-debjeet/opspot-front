...
var WalletUSDPayoutsComponent = /** @class */ (function () {
    function WalletUSDPayoutsComponent(_componentFactoryResolver, router, session) {
        this._componentFactoryResolver = _componentFactoryResolver;
        this.router = router;
        this.session = session;
    }
    WalletUSDPayoutsComponent.prototype.ngOnInit = function () { };
    WalletUSDPayoutsComponent.prototype.ngAfterViewInit = function () {
        this.loadComponent();
    };
    WalletUSDPayoutsComponent.prototype.loadComponent = function () {
    ...
    ], WalletUSDPayoutsComponent.prototype, "host", void 0);
    WalletUSDPayoutsComponent = __decorate([
        core_1.Component({
    ...
    return WalletUSDPayoutsComponent;
}());
exports.WalletUSDPayoutsComponent = WalletUSDPayoutsComponent;
