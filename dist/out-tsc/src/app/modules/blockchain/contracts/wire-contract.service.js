...
var WireContractService = /** @class */ (function () {
    function WireContractService(web3Wallet, tokenContract) {
        this.web3Wallet = web3Wallet;
        this.tokenContract = tokenContract;
        this.load();
    }
    WireContractService_1 = WireContractService;
    WireContractService.prototype.load = function () {
    ...
    WireContractService.prototype.wire = function (gasPriceGwei) {
    ...
    // Wire
    WireContractService.prototype.create = function (receiver, amount, message) {
    ...
    // Service provider
    WireContractService._ = function (web3Wallet, tokenContract) {
        return new WireContractService_1(web3Wallet, tokenContract);
    };
    var WireContractService_1;
    WireContractService = WireContractService_1 = __decorate([
        core_1.Injectable(),
        __metadata("design:paramtypes", [web3_wallet_service_1.Web3WalletService,
            token_contract_service_1.TokenContractService])
    ], WireContractService);
    return WireContractService;
}());
exports.WireContractService = WireContractService;
//# sourceMappingURL=wire-contract.service.js.map